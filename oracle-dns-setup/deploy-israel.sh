...
echo "🚀 Déploiement DNS Israël..."


COUNTRY_NAME="Israel"
COUNTRY_CODE="IL"
PRIMARY_DNS="192.116.142.34"
...
services:
  powerdns:
    ...
    container_name: powerdns-israel
    ports:
      - "53:53/tcp"
      - "53:53/udp"
    environment:
...
docker exec mysql-israel mysql -u pdns -ppdns pdns -e "
...
echo "✅ Déploiement Israël terminé !"
