...
echo "🚀 Déploiement DNS Thaïlande..."


COUNTRY_NAME="Thailand"
COUNTRY_CODE="TH"
PRIMARY_DNS="203.144.207.29"
...
services:
  powerdns:
    ...
    container_name: powerdns-thailand
    ports:
      - "53:53/tcp"
      - "53:53/udp"
    environment:
...
docker exec mysql-thailand mysql -u pdns -ppdns pdns -e "
...
echo "✅ Déploiement Thaïlande terminé !"
