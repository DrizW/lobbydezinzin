...
services:
  powerdns:
    ...
    container_name: powerdns-taiwan
    ports:
      - "53:53/tcp"
      - "53:53/udp"
    environment:
...
docker exec mysql-taiwan mysql -u pdns -ppdns pdns -e "
...
echo "✅ Déploiement Taiwan terminé !"
